...
public class DeleteProject {
    ...
    private final IDBRemove databaseRemover = new DBManagerRemoveController();
    // The list of allProjects in the system
    private final List<Project> allProjects;
    private Project projectToBeRemoved;
    /**
     * Empty constructor (would be autogenerated by Java if not included anyway)
     */
    public DeleteProject(List<Project> allProjects) {

        System.out.println("CONSTRUCTOR IS CALLED");
        System.out.println("HERE IS ALL PROJECTS " + allProjects.toString());
